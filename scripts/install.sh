...
if [ -f .env ]; then
  ...
  PROJECTS_DIR="${WORKSPACE_TOOL_HOST_PROJECTS_DIR:-$HOME/Desktop}"
...
WORKSPACE_TOOL_HOST_WORKSPACE_DIR=$WORKSPACE_DIR
WORKSPACE_TOOL_HOST_PROJECTS_DIR=$PROJECTS_DIR
