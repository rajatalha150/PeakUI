...
- **Task Organization Rail:** Open Claw task threads include folder grouping, session tags, built-in search, and per-thread organization controls directly from the rail menu.
