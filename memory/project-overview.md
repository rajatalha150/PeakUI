...
- Open Claw agent workspace with task modes, shell execution (container/host), filesystem access, code sandbox, browser tool, canvas artifacts, and multi-layer memory
