...
if (-not (Test-Path $EnvFile)) {
    ...
    $envContent = @(
        ...
        "",
        "# Windows Docker Desktop Ollama host (container -> host via Docker DNS)",
        "OLLAMA_HOST=http://host.docker.internal:11434",
        "",
        "# Host paths mounted into the app container",
        "WORKSPACE_TOOL_HOST_HOME_DIR=C:\Users\$env:USERNAME",
        "WORKSPACE_TOOL_HOST_TMP_DIR=C:\Users\$env:USERNAME\AppData\Local\Temp",
        "WORKSPACE_TOOL_HOST_WORKSPACE_DIR=$WorkspaceDir",
        "WORKSPACE_TOOL_HOST_PROJECTS_DIR=$ProjectsDir",
        "",
