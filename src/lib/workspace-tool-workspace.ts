...
const WORKSPACE_TOOL_WORKSPACE_CONTAINER_ROOT = '/mnt/workspace-tool/workspace'
...
export function getWorkspaceToolWorkspaceHostRoot(): string {
  return normalizeHostPath(
    process.env.WORKSPACE_TOOL_HOST_WORKSPACE_DIR || DEFAULT_WORKSPACE_TOOL_WORKSPACE_HOST_ROOT
  )
}

export function getWorkspaceToolWorkspaceContainerRoot(): string {
  return WORKSPACE_TOOL_WORKSPACE_CONTAINER_ROOT
}

export function getWorkspaceToolWorkspaceLabel(): string {
  return `${getWorkspaceToolWorkspaceHostRoot()} (mounted at ${WORKSPACE_TOOL_WORKSPACE_CONTAINER_ROOT})`
}
...
async function ensureWorkspaceAliasExists(): Promise<void> {
  ...
  const hostAliasPath = getWorkspaceToolWorkspaceHostRoot()
  ...
  // at /mnt/workspace-tool/workspace), no extra symlink alias is required.
...
export async function ensureWorkspaceToolWorkspaceAlias(): Promise<void> {
...
export function getUwafClearWebDir(): string {
  return path.join(getWorkspaceToolWorkspaceHostRoot(), 'research', 'clear_web')
}

export function getUwafDarkWebDir(): string {
  return path.join(getWorkspaceToolWorkspaceHostRoot(), 'research', 'dark_web')
}
