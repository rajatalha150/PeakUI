...
describe('openclaw-tool-results: truncateWithMarker', () => {
...
describe('openclaw-tool-results: compactLinks', () => {
...
describe('openclaw-tool-results: isJunkLinkUrl', () => {
