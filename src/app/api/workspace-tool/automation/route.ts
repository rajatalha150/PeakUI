...
} from '@/lib/workspace-tool-automation'
...
async function requireAutomationAccess() {
  return requireCurrentAuthWithPermissions(['workspace-tool.use', 'workspace-tool.automation'], {
...
export async function GET() {
  ...
  try {
    ...
    console.error('[workspace-tool/automation] GET error:', error)
